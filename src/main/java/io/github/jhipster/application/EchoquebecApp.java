...
public class EchoquebecApp {

    private static final Logger log = LoggerFactory.getLogger(EchoquebecApp.class);

    private final Environment env;

    public EchoquebecApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes echoquebec.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(EchoquebecApp.class);
